...
echo "you can continue and run 'install.sh' and then 'start.sh'"
echo "to attempt to intall and launch all the prerequisites"
echo "and applications for this project."
echo ""
...
echo "is always running live at https://minecrossing.xyz"